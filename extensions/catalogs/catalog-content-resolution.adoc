...
If you do not specify any catalog selection criteria, {olmv1-first} might select from any available catalog on the cluster that provides the requested package.

By default, bundles that are not deprecated are preferred over deprecated bundles during resolution.
