...
`--bundles`:: Specifies a comma-separated list of additional bundle images to add to the index.
`--from-index`:: Specifies the previously pushed index.
`--tag`:: Specifies the image tag to apply to the updated index image.
`--pull-tool`:: Specifies the tool used to pull container images.
+
where:
+
--
