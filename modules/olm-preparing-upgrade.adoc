...
Red Hat Customer Portal Labs provide tools that help administrators prepare to update their Operators.

You can use these tools to search for Operators and verify the available Operator versions per update channel across different releases of {product-title}. Operators managed by Cluster Version Operator (CVO) are not included.
