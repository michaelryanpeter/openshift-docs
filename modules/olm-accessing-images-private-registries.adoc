...
[role="_abstract"]
To install Operators whose images are hosted in private registries by using Operator Lifecycle Manager (OLM), you can create pull secrets in {product-title} and reference them from catalog sources.
