...
`spec.secrets`:: Specifies any required secrets for accessing private registries.
...
----
The `etcd-operator` entry shows the service account for an installed etcd Operator.
--
