...
[role="_abstract"]
An Operator group defines multitenant configuration for OLM-installed Operators through an `OperatorGroup` resource. It selects target namespaces where the required RBAC access is generated for member Operators in {product-title}.
