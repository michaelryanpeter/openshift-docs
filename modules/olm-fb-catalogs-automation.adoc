...
[role="_abstract"]
Operator authors and catalog maintainers can automate file-based catalog maintenance with CI/CD workflows. You can use GitOps automation to validate catalog changes, verify bundle images, and automatically rebuild and republish catalog images.
