...
`<channel>`:: Optional: Specifies the channel as an array, such as `[pipelines-1.14]` or `[latest]`, for the package you want to install or update.
...
[source,text]
----
clusterextension.olm.operatorframework.io/pipes created
----
