...
[role="_abstract"]
Operator Lifecycle Manager (OLM) places Operator and Operand pods on arbitrary worker nodes by default. You can steer pod placement to specific nodes by using projects with node selectors, taints, and tolerations.
