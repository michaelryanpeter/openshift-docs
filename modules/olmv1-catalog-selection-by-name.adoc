...
[source,text]
----
olm.operatorframework.io/metadata.name: <catalog_metadata_name>
----

The following example resolves the `<example_extension>-operator` from the catalog with the `openshift-redhat-operators` label:
