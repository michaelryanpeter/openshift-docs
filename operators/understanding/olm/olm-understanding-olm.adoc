...
[role="_abstract"]
You can use this overview to understand the custom resources and concepts that drive Operator Lifecycle Manager (OLM) in {product-title}. The resources include cluster service versions (CSVs), catalog sources, subscriptions, and Operator groups.
